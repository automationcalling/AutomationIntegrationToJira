package com.automationcalling.utils.restassured;
...
import static com.automationcalling.utils.common.Constant.PROPRETYFILEPATH;
...
public class RestAssuredCore {
    ...
    public static void initializeLogger() throws IOException {
        printLogFile = new PrintStream(new BufferedOutputStream(new FileOutputStream(new File(CommonMethods.returnProperties(PROPRETYFILEPATH, "logConfigFile")), true)));
    ...
    /**
     *
     * @param payload pass body as String
     * @return
     */
    public RestAssuredCore setBodyasString(String payload) {
        request = request.body(payload).log().all();
        return this;
    }
